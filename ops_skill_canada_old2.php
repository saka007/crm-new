...
$mf1=$obj->display('mis_client_files','  leadId='.$_SESSION['ID']);
...
<ul class="nav nav-tabs">
  ...
  <li class="nav-item"><a class="nav-link openobs" data-toggle="tab" href="#tab18"><strong>Messages</strong></a></li>
</ul>
 ...
 <!--TAB3--> 
  ...
  <div class="col-sm-4 form-group"><label >Spouse Qualification</label>
	...
	<select class="form-control" name="specaAssmBody">
		...
		<option value="CES" <?php if($ops1['specaAssmBody']=="CES") { echo 'selected="selected"';}?>>CES</option>
		</select>
	</div>
        ...
        ?>
                 <div class="row">
                  <a href="uploads/clientdocs/<?php echo $upe1['bach_seal_trans_unv']; ?>" class="btn btn-success btn-icon-split">
                    ...
                    <span class="text">Seal Transcript From University (Bachelors)-<?php echo $upe1['bach_seal_trans_unv']; ?></span>
                  </a>
                  <div class="col-sm-3 form-group">
        ...
        ?>
                 <div class="row">
                  <a href="uploads/spousedocs/<?php echo $upes1['bach_seal_trans_unv']; ?>" class="btn btn-success btn-icon-split">
                    ...
                    <span class="text">Seal Transcript From University (Bachelors)-<?php echo $upes1['bach_seal_trans_unv']; ?></span>
                  </a>
                  <div class="col-sm-3 form-group">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Status Updates<h6 align="left" class="text-primary">last updated (<?php echo $st1['date'] ; ?>)</h6></h6>
                ...
                <div class="card-body">
                  <div class="chart-area">
                    ...
                    <label><?php echo $st1['status']; ?>
                    <br><br>
                    <img class="chart-area" src="<?php echo "uploads/status/".$st1['file']; ?>">
                  </div>
                </div>
              </div>
            </div>
...
$('.openobs').on('click',function(){
    $('.modal-body').load('user_messenger.php?lead=<?php echo $_GET['lead'];?>',function(){
