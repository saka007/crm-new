...
<div class="row">
		...
		<?php
$query=" t1.feeAgreeDate between '".date('Y-m-d',strtotime($_POST["sdate"]))."' and '".date('Y-m-d',strtotime($_POST["edate"]))."' and paidyet!='0' and t3.contract_signed !='' and t1.service_interest in (26,27,28,29,66,67,68,69,70,71,73,74,93,94,95,96,100,103,107,108,109,113,114,115)";
			    ...
			    <tbody>
			    	...
			    	if($result->num_rows>0){
			    		...
			    		while($row=$result->fetch_assoc())
			    		{
			    			...
			    			$ei=$obj->display('dm_lead_observation','leadId='.$row['leadid']);
							$ei1=$ei->fetch_array();
			    			?>
			    			<tr>
			    				<td><?php echo $i;?></td>
			    				...
			    				<td><a href="uploads/Gary/<?php echo $row['contract_signed'];?> " target="_blank"><?php echo $row['contract_signed'];?></a></td>
