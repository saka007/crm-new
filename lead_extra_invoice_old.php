...
$lead=$obj->display('old_data_2','agreeNo="'.$_GET['agreement'].'"');
$lead1=$lead->fetch_array();

$recpt=$obj->display('dm_3party_payment_old','id='.$_GET['receipt']);
...
<div class="col-sm-6 text-sm-left"><a href="#" onclick="javascript:printPage(print);" class="btn btn-info">Print Receipt</a></div>
				...
				<div class="row">
			        <div class="col-12">
						...
						<h5 style="padding:0 0 5px; margin:0;font-size:1rem; line-height:1"><label>Agreement No. : </label> <?php echo $lead1['agreeNo'];?></h5>
			                ...
			                <div class="col-12 col-md-6 col-lg-6 float-left">
			                    <div class="card  height">
			                        ...
			                        <div class="card-block" style="margin: 0 10px;">
			                            <strong><?php echo $lead1['client_name']; ?>:</strong><br>
			                            <?php echo $lead1['branch']; ?><br>
			                            <?php echo $lead1['branch']; ?><br>
		                        	</div>
			                    </div>
...
<?php 
$fg=$obj->display('dm_3party_payment_old','id='.$_GET['receipt']);
