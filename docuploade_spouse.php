...
$up=$obj->display('dm_spouse_edu',"leadid=".$_SESSION['ID']);
$up1=$up->fetch_array();
$em=$obj->display('dm_employee',"id=".$cl1['assignTo']);
$em1=$em->fetch_array();
$ag=$obj->display('dm_lead_contract','leadId='.$_SESSION['ID']);
$ag1=$ag->fetch_array();
$mf=$obj->display('mis_client_files','category=\'se\' and leadId='.$_SESSION['ID']);
...
if ( 0 < $_FILES['con_mark_sheet_m']['error'] ) 
    ...
    else 
  {
    $filename=time().'_'.$_FILES['con_mark_sheet_m']['name'];
        move_uploaded_file($_FILES['con_mark_sheet_m']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    $data=array('con_mark_sheet_m'=>$filename);
    $obj->update('dm_spouse_edu',$data,'leadid='.$_SESSION['ID']);
  }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['con_mark_sheet_b']['name'];
        move_uploaded_file($_FILES['con_mark_sheet_b']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['ind_mark_sheet_m']['name'];
        move_uploaded_file($_FILES['ind_mark_sheet_m']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['revised_eca_m']['name'];
        move_uploaded_file($_FILES['revised_eca_m']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['revised_eca_b']['name'];
        move_uploaded_file($_FILES['revised_eca_b']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['revised_wes_eca_m']['name'];
        move_uploaded_file($_FILES['revised_wes_eca_m']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['conv_cert_m']['name'];
        move_uploaded_file($_FILES['conv_cert_m']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['revised_wes_eca_b']['name'];
        move_uploaded_file($_FILES['revised_wes_eca_b']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['eca_m']['name'];
        move_uploaded_file($_FILES['eca_m']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['conv_cert_b']['name'];
        move_uploaded_file($_FILES['conv_cert_b']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['ind_mark_sheet_b']['name'];
        move_uploaded_file($_FILES['ind_mark_sheet_b']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['bach_seal_trans_unv']['name'];
        move_uploaded_file($_FILES['bach_seal_trans_unv']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['eca_b']['name'];
        move_uploaded_file($_FILES['eca_b']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['intermediate']['name'];
        move_uploaded_file($_FILES['intermediate']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
    ...
    else 
  {
    $filename=time().'_'.$_FILES['ssc']['name'];
        move_uploaded_file($_FILES['ssc']['tmp_name'], 'uploads/spousedocs/' . $filename);
    }
  ...
  $obj->update('dm_spouse_edu',$stat,'leadid='.$_SESSION['ID']);
  
  include_once('maildocalert.php');
    ...
    if(isset($_FILES['upload-misc'.$i]) && isset($_POST['misc_name'.$i])){
         if ( 0 < $_FILES['upload-misc'.$i]['error'] ) 
          ...
          else 
          {
            ...
            move_uploaded_file($_FILES['upload-misc'.$i]['tmp_name'], 'uploads/spousedocs/' . $filename);
            $data=array('file_name'=>$filename,'category'=>"se",'approval'=>'','upload_date'=>date('Y-m-d'),'dipti'=>"0",'leadid'=>$_SESSION['ID']);
            //var_dump($data);
  ...
  header('Location: docuploade_spouse.php');  
...
$obj->display3('UPDATE dm_spouse_edu SET '.$_GET['col'].'= NULL where leadid='.$_SESSION['ID']);
...
?>    
            ...
            <div class="col-lg-10">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['con_mark_sheet_m']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Consolidated Mark sheet (Masters)-<?php echo $up1['con_mark_sheet_m']; ?></span>
                  </a>
                  <?php if ($up1['con_mark_sheet_m_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=con_mark_sheet_m" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['ind_mark_sheet_m']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['ind_mark_sheet_m']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Individual Mark Sheet (Masters)-<?php echo $up1['ind_mark_sheet_m']; ?></span>
                  </a>
                  <?php if ($up1['ind_mark_sheet_m_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=ind_mark_sheet_m" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['conv_cert_m']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['conv_cert_m']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Degree Award/Convocation Certificate(Masters)-<?php echo $up1['conv_cert_m']; ?></span>
                  </a>
                  <?php if ($up1['conv_cert_m_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=conv_cert_m" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php } ?>
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['con_mark_sheet_b']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Consolidated Mark sheet (Bachelors)-<?php echo $up1['con_mark_sheet_b']; ?></span>
                  </a>
                  <?php if ($up1['con_mark_sheet_b_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=con_mark_sheet_b" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['ind_mark_sheet_b']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['ind_mark_sheet_b']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Individual Mark Sheet (Bachelors)-<?php echo $up1['ind_mark_sheet_b']; ?></span>
                  </a>
                  <?php if ($up1['ind_mark_sheet_b_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=ind_mark_sheet_b" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['conv_cert_b']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['conv_cert_b']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Convocation Certificate(Bachelors)-<?php echo $up1['conv_cert_b']; ?></span>
                  </a>
                  <?php if ($up1['conv_cert_b_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=conv_cert_b" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php } ?>
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['eca_m']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">ECA Report(Masters)-<?php echo $up1['eca_m']; ?></span>
                  </a>
                  <?php if ($up1['eca_m_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=eca_m" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
 ...
 <?php if($up1['revised_eca_m']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['revised_eca_m']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Revised ECA Report(Masters)-<?php echo $up1['revised_eca_m']; ?></span>
                  </a>
                  <?php if ($up1['revised_eca_m_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=revised_eca_m" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['revised_wes_eca_m']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['revised_wes_eca_m']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Revised WES ECA Report(Masters)-<?php echo $up1['revised_wes_eca_m']; ?></span>
                  </a>
                  <?php if ($up1['revised_wes_eca_m_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=revised_wes_eca_m" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
...
<?php if($up1['eca_b']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['eca_b']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">ECA Report (Bachelors)-<?php echo $up1['eca_b']; ?></span>
                  </a>
                  <?php if ($up1['eca_b_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=eca_b" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['revised_eca_b']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['revised_eca_b']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Revised ECA Report(Bachelors)-<?php echo $up1['revised_eca_b']; ?></span>
                  </a>
                  <?php if ($up1['revised_eca_b_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=revised_eca_b" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['revised_wes_eca_b']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['revised_wes_eca_b']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Revised WES ECA Report(Bachelors)-<?php echo $up1['revised_wes_eca_b']; ?></span>
                  </a>
                  <?php if ($up1['revised_wes_eca_b_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=revised_wes_eca_b" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['revised_wes_eca_b']=="")
                  ...
                  <a href="#" class="btn btn-secondary btn-icon-split" id="openupload8">
                    ...
                    <span class="text">Revised WES ECA Report(Bachelor's)</span>
                  </a>
                ...
                <?php if($up1['intermediate']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['intermediate']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Intermediate-<?php echo $up1['intermediate']; ?></span>
                  </a>
                  <?php if ($up1['intermediate_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=intermediate" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['ssc']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['ssc']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                  ...
                  <?php if ($up1['ssc_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=ssc" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php } ?>
                 <?php if($up1['bach_seal_trans_unv']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['bach_seal_trans_unv']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Seal Transcript From University (Bachelors)-<?php echo $up1['bach_seal_trans_unv']; ?></span>
                  </a>
                  <?php if ($up1['bach_seal_trans_unv_a']!="1") { ?>
                  <a href="docuploade_spouse.php?col=bach_seal_trans_unv" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php } ?>
                 ...
                 <?php if ($mf->num_rows > 0) {
                   ...
                   <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $mf1['file_name']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                  ...
                  <a href="docuploade_spouse.php?misc=<?php echo $mf1['id']; ?>" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
            ...
            <!--add misc-->
                  ...
                  </div><input type="file" class="inputfile" id="upload-misc" name="upload-misc">                  <input type="hidden"  id="misc_count" name="misc_count">
