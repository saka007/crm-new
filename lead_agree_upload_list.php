...
if($_POST['region']!="") { 	$query.=" and region=".$_POST['region'];}
					...
					$result = $obj->display3('SELECT * FROM `dm_lead_contract` t1 INNER JOIN dm_lead t2 on t1.leadid=t2.id WHERE t1.contract="" and t2.i_p=""');
...
$em=$obj->display('dm_employee','id='.$ser1['Counsilor']); $em1=$em->fetch_array();
					    	...
					    	<tr>
								...
								<td style="text-align: center;"><?php echo $prog1["name"];?></td>
