...
if($_POST['action']=='add')
{
$rt=$obj->display('dm_observation_file','country="'.$_POST['country'].'" and service="'.$_POST['program'].'"');
if($rt->num_rows==0)
{
 if ( 0 < $_FILES['avatar']['error'] ) {
	...
	$res=$obj->insert('dm_observation_file',$data);
if($res)
{
...
{
$obj->delete("dm_observation_file","id=".$_POST['del_id']); 
}
?>