					...
					<div class="card">
						...
						<div class="card-body">
                          <table class="table table-striped table-bordered display nowrap" id="mydataTable">
								...
								<?php
								$i=1;
								$re=$obj->display("dm_source","status=1 order by name ASC"); 	
                        ...
                        $(document).ready(function() {
                            $('#popForm<?=$res2['id']?>').validate({
								...
								messages: {
									name: "Lead source name is required",
								},
                            errorElement: 'span',
                            ...
                            submitHandler: function() {
                                ...
                                $.ajax({
                                    url: 'process/source_process.php',
                                    type: 'POST',
...
$(document).ready(function() {
	...
	$('body').on('click','.btnDeleteAction',function(){ 
		...
		{ 
					$.ajax({
						url: "<?php echo $base_url;?>/process/source_process.php",
						type: "POST",
						cache: false,
