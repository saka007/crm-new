...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Access Hierarchy Management</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						<li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
						<li class="breadcrumb-item active">Access Hierarchy Management</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<table class="table table-striped table-bordered display nowrap" id="mydataTable">
								...
								$re=$obj->display("dm_role","status=1 and id!=1 order by name ASC"); 	
	...
	$('body').on('click','.btnDeleteAction',function(){ 
		...
		{ 
					...
					$.ajax({
						...
						url: "<?php echo $base_url;?>/process/role_process.php",
