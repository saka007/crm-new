...
?>
                ...
                <div class="col-sm-10">
                    ...
                    <h4 class="mb-3" style="color:#2cb674;">Leave Type Management <a href="javascript:void(0);" class="btn btn-info pull-right" data-toggle="modal" data-target="#newForm"  style="background:#2cb674;">Add New <i class="fa fa-plus"></i></a></h4>
                            ...
                            <table class="table table-striped table-bordered" id="dataTables-Table" style="width:100%">
								...
								$re=$obj->display("dm_leave_type","status=1 order by name ASC"); 	
