            ...
            <div class="col-lg-10">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['copr']; ?>" class="btn btn-<?php if($up1['copr_a']=="0"){ 
                ...
                <?php if($up1['vphoto_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['vphoto']; ?>" class="btn btn-<?php if($up1['vphoto_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['final_visa_docfb_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['final_visa_docfb']; ?>" class="btn btn-<?php if($up1['final_visa_docfb_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['final_visa_docfull']; ?>" class="btn btn-<?php if($up1['final_visa_docfull_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  <?php if($up1['mcert_re_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['mcert_re']; ?>" class="btn btn-<?php if($up1['mcert_re_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['bcert_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['bcert']; ?>" class="btn btn-<?php if($up1['bcert_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-<?php if($up1['mcert_re_a']=="0"){ 
                    echo "exclamation-triangle";} else { echo "check";}?>"></i>
                ...
                <?php if($up1['niddoc_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['niddoc']; ?>" class="btn btn-<?php if($up1['niddoc_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['marraige_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['marraige']; ?>" class="btn btn-<?php if($up1['marraige_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-<?php if($up1['marraige_a']=="0"){ 
                    echo "exclamation-triangle";} else { echo "check";}?>"></i>
                    </span>
                ...
                <?php if($up1['ielts_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['ielts']; ?>" class="btn btn-<?php if($up1['ielts_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['passport_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['passport']; ?>" class="btn btn-<?php if($up1['passport_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['passport_new_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['passport_new']; ?>" class="btn btn-<?php if($up1['passport_new_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['pcc_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['pcc']; ?>" class="btn btn-<?php if($up1['pcc_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['photo_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['photo']; ?>" class="btn btn-<?php if($up1['photo_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['resume_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/clientdocs/<?php echo $up1['resume']; ?>" class="btn btn-<?php if($up1['resume_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
