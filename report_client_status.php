<?php include_once("header.php");	?>
		...
		<div class="col-sm-10">
		<div class="row"><div class="col-sm-6"><h4 class="mb-3" style="color:#2cb674;">Client Status Report</h4></div></div>
...
<select name="statusTo" class="form-control">
...
<option value="Visa Ganted">Visa Ganted</option>
<option value="Refund">Refund</option>
<option value="Closed">Closed</option>
</select>
</div>

<?php if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="RMSM" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="FMP" || $_SESSION['TYPE']=="BM") { 
if($_SESSION['TYPE']!="BM") {
?>		
...
<?php
$query="1=1";
if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="FMP" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="RMSM" || $_SESSION['TYPE']=="BM") { 	
...
{
if($_POST['statusTo']!="") { 
$query.=" and status='".$_POST['statusTo']."'";
}
...
?>
		...
		<h4 class="mt-2" style="color:#2cb674;">Client Status Report</h4>
