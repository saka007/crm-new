...
<div class="col-sm-10">
		<div class="row"><div class="col-sm-6"><h4 class="mb-3" style="color:#2cb674;">ITA Pending Client Report</h4></div></div>
...
if($_POST)
{
$query.=" and T2.regdate between '".date('Y-m-d',strtotime($_POST["sdate"]))."' and '".date('Y-m-d',strtotime($_POST["edate"]))."' and T1.itaReceDate='' ";

?>

		<div class="row">
		<div class="col-sm-12 text-center">
		<h4 class="mt-2" style="color:#2cb674;">ITA Pending Client Report</h4>
...
<script>
    $(document).ready(function() {
        $('#dataTable').DataTable({
			...
			{
                extend: 'excel',
                title: 'ITA Pending Client Report',
