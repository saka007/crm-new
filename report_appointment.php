...
<div class="row"><div class="col-sm-6"><h4 class="mb-3" style="color:#2cb674;">Appointment Report</h4></div></div>
...
if($_SESSION['ID']=='6')
{
 ...
 if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="RMSM" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="FMP" || $_SESSION['TYPE']=="BM") { 
...
<?php
$query="1=1";
if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="FMP" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="RMSM" || $_SESSION['TYPE']=="BM" || $_SESSION['TYPE']!="ABM") { 	
...
?>
		...
		<h4 class="mt-2" style="color:#2cb674;">Appointment Report</h4>
