<?php include_once("header.php");	?>
		...
		<div class="row"><div class="col-sm-6"><h4 class="mb-3" style="color:#2cb674;">Monthly Discount Report</h4></div></div>
...
<?php if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="RMSM" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="FMP" || $_SESSION['TYPE']=="FO" || $_SESSION['TYPE']=="BM") { 
if($_SESSION['TYPE']!="BM") {
?>		
...
$query.=" and paidYet!=0 and discount!=0 and feeAgreeDate between '".date('Y-m-d',strtotime($_POST["sdate"]))."' and '".date('Y-m-d',strtotime($_POST["edate"]))."'";
...
?>
		...
		<h4 class="mt-2" style="color:#2cb674;">Discount Report</h4>
...
$gh=$obj->display('dm_lead_contract','leadId='.$row['id']); $gh1=$gh->fetch_array(); 
 ...
 <tfoot>
			  <tr><th></th><th></th><th></th><th></th><th></th><th></th><th>Total</th><th><?=$discount;?></th></tr>
			  </tfoot>
			</table>
