...
$up=$obj->display('dm_spouse_personal',"leadid=".$_SESSION['ID']);
$up1=$up->fetch_array();
...
if ( 0 < $_FILES['copr']['error'] ) 
  ...
  $obj->update('dm_spouse_personal',$stat,'leadid='.$_SESSION['ID']);
    ...
    if(isset($_FILES['upload-misc'.$i]) && isset($_POST['misc_name'.$i])){
         if ( 0 < $_FILES['upload-misc'.$i]['error'] ) 
          ...
          else 
          {
            ...
            $data=array('file_name'=>$filename,'category'=>"sp",'approval'=>'','upload_date'=>date('Y-m-d'),'dipti'=>"0",'leadid'=>$_SESSION['ID']);
            //var_dump($data);
...
?>    
  ...
  z-index: -1;
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Spouse Documents to be Uploaded</h1>
            ...
            <div class="col-lg-10">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Spouse Document List</h6>
                </div>
                <div class="card-body">
                  <p>
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['copr']; ?>" class="btn btn-success btn-icon-split">
                  ...
                  <?php if ($up1['copr_a']!="1") { ?>
                  <a onclick="confirmation(event)" href="docuploadp_spouse.php?col=copr" class="btn btn-danger btn-icon-split">
                ...
                <?php if($up1['vphoto']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['vphoto']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Visa Photo-<?php echo $up1['vphoto']; ?></span>
                  </a>
                  <?php if ($up1['vphoto_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=vphoto" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['final_visa_docfb']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['final_visa_docfb']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Final Visa Document FB-<?php echo $up1['final_visa_docfb']; ?></span>
                  </a>
                  <?php if ($up1['final_visa_docfb_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=final_visa_docfb" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['final_visa_docfull']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Final Visa Document FULL-<?php echo $up1['final_visa_docfull']; ?></span>
                  </a>
                  <?php if ($up1['final_visa_docfull_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=final_visa_docfull" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['bcert']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['bcert']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Birth Certificate-<?php echo $up1['bcert']; ?></span>
                  </a>
                  <?php if ($up1['bcert_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=bcert" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['niddoc']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['niddoc']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">National ID Document-<?php echo $up1['niddoc']; ?></span>
                  </a>
                  <?php if ($up1['niddoc_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=niddoc" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['ielts']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['ielts']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">IELTS SCORE CARD-<?php echo $up1['ielts']; ?></span>
                  </a>
                  <?php if ($up1['ielts_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=ielts" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['passport']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['passport']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Passport-<?php echo $up1['passport']; ?></span>
                  </a>
                  <?php if ($up1['passport_a']!="1") { ?>
                ...
                <?php if($up1['passport_new']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['passport_new']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Passport New-<?php echo $up1['passport_new']; ?></span>
                  </a>
                  <?php if ($up1['passport_new_a']!="1") { ?>
                ...
                <?php if($up1['pcc']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['pcc']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                  ...
                  <?php if ($up1['pcc_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=pcc" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['photo']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['photo']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Photo PA-<?php echo $up1['photo']; ?></span>
                  </a>
                  <?php if ($up1['photo_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=photo" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php if($up1['resume']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['resume']; ?>" class="btn btn-success btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-check"></i>
                    </span>
                    <span class="text">Resume-<?php echo $up1['resume']; ?></span>
                  </a>
                  <?php if ($up1['resume_a']!="1") { ?>
                  <a href="docuploadp_spouse.php?col=resume" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
                ...
                <?php } ?>
                 ...
                 <?php if ($mf->num_rows > 0) {
                  ...
                  <a href="docuploadp_spouse.php?misc=<?php echo $mf1['id']; ?>" class="btn btn-danger btn-icon-split">
                    <span class="icon text-white-50">
                      <i class="fas fa-trash"></i>
                    </span>
                  </a>
  ...
  <script>
    ...
    $('#openupload15').click(function(){ $('#upload15').trigger('click'); });
