...
$up=$op=$obj->display('dm_spouse_edu',"leadid=".$_SESSION['ID']);
$up1=$up->fetch_array();
            ...
            <div class="col-lg-10">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['con_mark_sheet_m']; ?>" class="btn btn-<?php if($up1['con_mark_sheet_m_a']=="0"){ 
                ...
                <?php if($up1['ind_mark_sheet_m_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['ind_mark_sheet_m']; ?>" class="btn btn-<?php if($up1['ind_mark_sheet_m_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['conv_cert_m']; ?>" class="btn btn-<?php if($up1['conv_cert_m_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['con_mark_sheet_b_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['con_mark_sheet_b']; ?>" class="btn btn-<?php if($up1['con_mark_sheet_b_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['ind_mark_sheet_b']; ?>" class="btn btn-<?php if($up1['ind_mark_sheet_b_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['conv_cert_b']; ?>" class="btn btn-<?php if($up1['conv_cert_b_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['eca_m']; ?>" class="btn btn-<?php if($up1['eca_m_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['revised_eca_m']; ?>" class="btn btn-<?php if($up1['revised_eca_m_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['revised_wes_eca_m']; ?>" class="btn btn-<?php if($up1['revised_wes_eca_m_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['eca_b']; ?>" class="btn btn-<?php if($up1['eca_b_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['revised_eca_b']; ?>" class="btn btn-<?php if($up1['revised_eca_b_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['revised_wes_eca_b_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['revised_wes_eca_b']; ?>" class="btn btn-<?php if($up1['revised_wes_eca_b_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                ...
                <?php if($up1['intermediate_a']!="")
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['intermediate']; ?>" class="btn btn-<?php if($up1['intermediate_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['ssc']; ?>" class="btn btn-<?php if($up1['ssc_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
                  ...
                  { ?>
                  <div class="my-2"></div>
                  <a href="uploads/spousedocs/<?php echo $up1['bach_seal_trans_unv']; ?>" class="btn btn-<?php if($up1['bach_seal_trans_unv_a']=="0"){ 
                    echo "danger";} else { echo "primary";}?> btn-icon-split">
                    <span class="icon text-white-50">
