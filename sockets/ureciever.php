...
socket.on('connect', function () {
    ...
    socket.on('broadcast', function(data){
      ...
      $("#reloader").load("user_messenger.php?lead=<?php echo $_GET['lead'];?> #msg_history",function (a) {
    ...
    //   result=JSON.parse(result);
      ...
      if(last_message!=null && ncount!=null){
       ...
       // if(ncount>message_count){
          ...
          //$("#malert").css("display","");
          $("#mnort").find("div").html("<a href='"+data['page']+"'>You have "+ncount+" new "+(ncount>1?"messages":"message")+" from "+data['name']+" !!</a>");
          $("#mnort").css("display","");
    //}
