...
$query.=" and paidYet=0 and regdate between '".date('Y-m-d',strtotime($_POST["sdate"]))."' and '".date('Y-m-d',strtotime($_POST["edate"]))."'";
			...
			<table class="table table-striped table-bordered" id="dataTables-Table" style="width:100%">
			  ...
			  <thead>
			    ...
			    <tr>
			      ...
			      <th>Name</th>
				  <?php if($_SESSION['TYPE']=="SA" || $_SESSION['TYPE']=="RT") { ?>
			      <th>Email</th>
			      <th>Mobile</th>
			      <th>Counselor</th>
					<?php } ?>
...
if ($_SESSION['TYPE']=="SA")
{
					$result = $obj->display('dm_lead','1=1 order by id desc');
				}
				else
				{
