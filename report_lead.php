...
<div class="col-sm-10">
		...
		<div class="row"><div class="col-sm-6"><h4 class="mb-3" style="color:#2cb674;">Lead Report</h4></div></div>
...
if($_SESSION['ID']=='6')
{
 ...
 if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="RMSM" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="FMP" || $_SESSION['TYPE']=="BM" || $_SESSION['TYPE']=="ABM" || $_SESSION['TYPE']=="RT") { 
if($_SESSION['TYPE']!="BM"){
...
<?php
$query="1=1";
if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="FMP" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="RMSM" || $_SESSION['TYPE']=="BM" || $_SESSION['TYPE']=="ABM" || $_SESSION['TYPE']=="RT") { 	
if($_POST['region']!="") { 	$query.=" and region=".$_POST['region'];}
if($_SESSION['ID']=="25") { 	$query.=" and region in (3,4,7)";}
if($_SESSION['ID']=="6") { 	$query.=" and region in (5,6,8)";}
...
if($_SESSION['TYPE']=="BM" || $_SESSION['TYPE']=="ABM")
{
...
?>
		...
		<h4 class="mt-2" style="color:#2cb674;">Lead Report</h4>
			...
			<table class="table" id="dataTable" style="width:100%">
			  ...
			  <thead>
			    ...
			    <tr>
			      ...
			      <th>Name</th>
			      <?php if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="RMSM" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="FMP")
			      { ?>
			      <th>Mobile</th>
			      <th>Email</th>
			  <?php }?>
...
if($row["market_source"]!=""){
$mak=$obj->display("dm_source","id=".$row["market_source"]); 	$mak1=$mak->fetch_array(); }
$em=$obj->display('dm_employee','id='.$row['assignTo']); $em1=$em->fetch_array();
