...
else
{
	$opsId=$_POST['opsId'];
			...
			$obj->update('dm_ops_student_visa',$data,'id='.$_POST['opsId']);
}
...
header("location:ops_student_visa.php?lead=".$_POST['lead']);
...
<div class="col-sm-4 form-group"><label >Date of retaintion</label><input type="text" class="form-control" id="retnDate" name="retnDate" value="<?php echo date('d-m-Y',strtotime($lead1['agreeDate']));?>" readonly=""  ></div>
  ...
  <div class="row" style="overflow:hidden">
	...
	<div class="col-sm-3 form-group"><label>Documents Submit Date</label><input type="text" class="form-control" id="date1" name="docSubDate"  value="<?php echo $ops1['docSubDate'];?>" ></div>
	<div class="col-sm-3 form-group"><label>Planned Travel Date</label><input type="text" class="form-control" id="date2" name="planTravDate"  value="<?php echo $ops1['planTravDate'];?>" ></div>
	<div class="col-sm-3 form-group"><label>Biometrics Required</label><select class="form-control" name="bioReq" >
		<option value="">Select</option>
	...
	<div class="col-sm-3 form-group"><label>University/College Name</label><input type="text" class="form-control" id="" name="university"  value="<?php echo $ops1['university'];?>"></div>
