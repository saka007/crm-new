...
$.ajax({
    ...
    success: function(result){
        ...
        $.ajax({
          ...
          async:true,done: function(result){
...
//  }, 5000);
function update_chat_history_data(argument) {
  var data={}
           ...
           if(msg.mine==1){
            ...
            if(msg.attachments.length>0){
              ...
              $(msg.attachments).each( function(j,f) {  
                  chat_html=chat_html+'<a href="uploads/attachments/'+f+'" class="btn btn-icon-split attachment"><span class="icon text-white-50"> <i class="fa fa-file"></i></span><span class="text">'+f+'</span></a>';
            });
