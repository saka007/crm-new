<?php include_once("header.php");	?>
		...
		<div class="row"><div class="col-sm-6"><h4 class="mb-3" style="color:#2cb674;">Client Report</h4></div></div>
...
<?php
if($_SESSION['TYPE']=="SA" ||  $_SESSION['TYPE']=="FMP" || $_SESSION['TYPE']=="DGM" || $_SESSION['TYPE']=="RMSM") { 	
$query="1=1";
...
?>
		...
		<h4 class="mt-2" style="color:#2cb674;">Client Report</h4>
